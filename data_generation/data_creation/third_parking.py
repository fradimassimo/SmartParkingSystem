"""
Based on the structure ("closed_parking_structures.json") generates 1766 sensors.
...
def generate_parking_data(parking_spots):
    """
...
def create_parking_dataset(input_file, output_file):
    ...
    for parking_set in all_parkings:
        all_data.extend(generate_parking_data(parking_set))
